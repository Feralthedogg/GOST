...
- FFI: `docs/ffi-guide.md`
- internals/testing: `docs/intrinsics-reference.md`, `docs/ownership-cheatsheet.md`, `docs/testing-guide.md`

Run CLI locally:

```powershell
cargo run --bin gs -- --help
```
